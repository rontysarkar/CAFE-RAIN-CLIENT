...
const Slider = ({ img, text }) => {
    return (
        <div className={` w-full bg-center bg-cover h-[52rem] bg-no-repeat `}
            style={
                {
        ...
        >
            <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                <div className="text-center">
                    <h1 className="text-3xl font-extrabold text-white lg:text-7xl">{text}</h1>
                    <h1 className="text-xl py-4 text-white lg:text-3xl ">From Your Favorite Restaurants!</h1>
